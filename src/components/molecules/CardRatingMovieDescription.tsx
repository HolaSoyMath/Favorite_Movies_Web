...
export interface CardRatingMovieDescriptionProps extends HTMLAttributes<HTMLDivElement> {
  fontData: string
  rating: number
  quantity: number
  className?: string
...
export default function CardRatingMovieDescription(params: CardRatingMovieDescriptionProps) {
  return (
